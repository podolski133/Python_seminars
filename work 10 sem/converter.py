...
Label(root, text="Выбрать валюту:", font="arial 12 bold", bg='#cfdde3').grid()
OptionMenu(root, var1, *currency_list).grid(column=3, row=0)


Label(root, text="Выбрать валюту:", font="arial 12 bold", bg='#cfdde3').grid()
OptionMenu(root, var2, *currency_list).grid(column=3, row=1)


Label(root, text="Введите сумму:", font="arial 12 bold", bg='#cfdde3').grid()
Entry(root, width=10, textvariable=cost, bg='white').grid(row=2, column=3)
